...
public interface MetadataParser {
    ...
    void setMetadata(String metadataFile, Block block, org.g_node.nix.File file, String headerFile, String markerFile, boolean metadataExists) throws IOException;
